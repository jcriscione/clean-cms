...
(function() {
	...
	describe('Campaigns Controller Tests', function() {
		...
		it('$scope.find() should create an array with at least one Page object fetched from XHR', inject(function(Campaigns) {
		...
		it('$scope.update() should update a valid Campaign', inject(function(Campaigns) {
			...
			// Set PUT response
			$httpBackend.expectPUT(/campaign\/([0-9a-fA-F]{24})$/).respond();
		...
		it('$scope.remove() should send a DELETE request with a valid segmentId and remove the Campaign from the scope', inject(function(Campaigns) {
